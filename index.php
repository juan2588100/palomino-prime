...
<?php include 'header.php'; ?>
    ...
    <main>
        ...
        <section class="hero" style="background-image: url('img/banner-palomino-final.png') !important; background-size: cover !important; background-position: center !important; background-repeat: no-repeat !important; min-height: 65vh; position: relative; margin-bottom: 80px; display: flex; align-items: center;">
